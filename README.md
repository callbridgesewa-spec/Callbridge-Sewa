...
3. Add attributes:
   ...
   - Managed dropdown lists (string, optional): `Departments`, `area`, `visitOptions` — store JSON arrays, e.g. `["LANGAR","C-1"]`, `["Noida","Beas"]`, and `["Beas Sewa","Local Visit"]`. The app reads/writes these on the same badge-counts document used for the dashboard.
