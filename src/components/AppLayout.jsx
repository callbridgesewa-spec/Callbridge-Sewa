 ...
 * @param {string} props.brandLogo - "SMS" for admin, "SMS" for user
 ...
 */
function AppLayout({ sidebarItems, roleLabel, brandLogo = 'SMS', renderTopBarRight, outletContext = {} }) {
    ...
    <div className="flex min-h-screen bg-[#e0f2f7]">
      ...
      >
        <div className="mb-6 flex items-center gap-2 px-2">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-900">Sewadar Management System</p>
