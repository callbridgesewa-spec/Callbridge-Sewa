      ...
      <div className="overflow-hidden rounded-lg bg-white p-2.5 shadow-sm sm:rounded-xl sm:p-4">
        ...
        {viewCallLog && (() => {
          ...
          const handleDownload = () => {
            ...
            docPdf.text('CALLING FORM', pageWidth / 2, 18, { align: 'center' })
            ...
            docPdf.text(`Badge ID: ${prospect.badgeId || '-'}`, marginX + 5, y + 21)
            docPdf.text(`Phone: ${prospect.phoneNumber || '-'}`, marginX + 100, y + 15)
            docPdf.text(`Address: ${prospect.address || '-'}`, marginX + 100, y + 21)
            y += 35
            ...
            for (let i = 1; i <= totalPages; i++) {
              ...
              docPdf.text(`Page ${i} of ${totalPages}`, pageWidth / 2, pageHeight - 5, { align: 'center' })
            }
            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-between border-b-2 border-red-600 bg-gradient-to-r from-red-600 to-red-700 px-6 py-4">
                  <div>
                    <h2 id="view-calllog-title" className="text-xl font-bold text-white">
                      Calling Form
                    </h2>
                    <p className="mt-1 text-xs text-red-100">
                      Submitted by <span className="font-medium">{log.submittedBy}</span> · {new Date(log.$createdAt).toLocaleString()}
                    </p>
                  </div>
                ...
                <div className="flex-1 space-y-5 overflow-y-auto px-6 py-5">
                  ...
                  <div className="rounded-xl border-2 border-slate-200 bg-gradient-to-br from-slate-50 to-white p-5 shadow-sm">
                    <div className="mb-3 flex items-center gap-2">
                      ...
                      <h3 className="text-base font-bold text-slate-900">Prospect Information</h3>
                    </div>
                    <div className="grid gap-3 sm:grid-cols-2">
                      <div>
                        <p className="text-xs font-medium uppercase tracking-wide text-slate-500">Name</p>
                        <p className="mt-1 text-sm font-semibold text-slate-900">{prospect.name || '-'}</p>
                      </div>
                      <div>
                        <p className="text-xs font-medium uppercase tracking-wide text-slate-500">Badge ID</p>
                        <p className="mt-1 text-sm font-semibold text-slate-900">{prospect.badgeId || '-'}</p>
                      </div>
                      <div>
                        <p className="text-xs font-medium uppercase tracking-wide text-slate-500">Phone Number</p>
                        <p className="mt-1 text-sm font-semibold text-slate-900">{prospect.phoneNumber || '-'}</p>
                      </div>
                      <div>
                        <p className="text-xs font-medium uppercase tracking-wide text-slate-500">Address</p>
                        <p className="mt-1 text-sm font-semibold text-slate-900">{prospect.address || '-'}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                    ...
                    <div className="rounded-xl border-2 border-red-200 bg-white p-5 shadow-sm">
                      <div className="mb-4 flex items-center gap-2">
                        ...
                        <h3 className="text-sm font-bold uppercase tracking-wider text-red-600">Calling Data Select Option</h3>
                      </div>
                      <div className="space-y-3">
                        <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                          <p className="text-xs font-medium text-slate-500">Select</p>
                          <p className="mt-1 text-sm font-semibold text-slate-900">{log.select || '-'}</p>
                        </div>
                        <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                          <p className="text-xs font-medium text-slate-500">Call Back</p>
                          <p className="mt-1 text-sm font-semibold text-slate-900">{log.callBack || '-'}</p>
                        </div>
                        <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                          <p className="text-xs font-medium text-slate-500">Not Interest</p>
                          <p className="mt-1 text-sm font-semibold text-slate-900">{log.notInterest || '-'}</p>
                        </div>
                        <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                          <p className="text-xs font-medium text-slate-500">Department of Sewa</p>
                          <p className="mt-1 text-sm font-semibold text-slate-900">{log.departmentOfSewa || '-'}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="rounded-xl border-2 border-red-200 bg-white p-5 shadow-sm">
                      <div className="mb-4 flex items-center gap-2">
                        ...
                        <h3 className="text-sm font-bold uppercase tracking-wider text-red-600">Transfer Data</h3>
                      </div>
                      <div className="space-y-3">
                        <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                          <p className="text-xs font-medium text-slate-500">Nominal List Select</p>
                          <p className="mt-1 text-sm font-semibold text-slate-900">{log.nominalListSelect || '-'}</p>
                        </div>
                        <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                          <p className="text-xs font-medium text-slate-500">Visit Select</p>
                          <p className="mt-1 text-sm font-semibold text-slate-900">{log.visitSelect || '-'}</p>
                        </div>
                        <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                          <p className="text-xs font-medium text-slate-500">Free Sewa</p>
                          <p className="mt-1 text-sm font-semibold text-slate-900">{log.freeSewa || '-'}</p>
                        </div>
                        <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                          <p className="text-xs font-medium text-slate-500">Attendance</p>
                          <p className="mt-1 text-sm font-semibold text-slate-900">{log.attendance || '-'}</p>
                        </div>
                        <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                          <p className="text-xs font-medium text-slate-500">Jatha Record</p>
                          <p className="mt-1 text-sm font-semibold text-slate-900">{log.jathaRecord || '-'}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-xl border-2 border-red-200 bg-white p-5 shadow-sm">
                    <div className="mb-4 flex items-center gap-2">
                      ...
                      <h3 className="text-sm font-bold uppercase tracking-wider text-red-600">Need to Work</h3>
                    </div>
                    <div className="space-y-4">
                      <div className="rounded-lg border border-slate-200 bg-gradient-to-br from-red-50 to-white p-4">
                        <p className="text-xs font-semibold uppercase tracking-wide text-red-700">Need to Work</p>
                        <p className="mt-2 text-sm text-slate-700 whitespace-pre-line">{log.needToWork || '-'}</p>
                      </div>
                      {(log.notes1 || log.notes2 || log.notes3) && (
                        <div className="grid gap-3 sm:grid-cols-3">
                          <div className="rounded-lg border border-slate-200 bg-gradient-to-br from-emerald-50 to-white p-4">
                            <p className="text-xs font-semibold uppercase tracking-wide text-emerald-700">Good participation</p>
                            <p className="mt-2 text-sm text-slate-700">{log.notes1 || '-'}</p>
                          </div>
                          <div className="rounded-lg border border-slate-200 bg-gradient-to-br from-blue-50 to-white p-4">
                            <p className="text-xs font-semibold uppercase tracking-wide text-blue-700">Positive</p>
                            <p className="mt-2 text-sm text-slate-700">{log.notes2 || '-'}</p>
                          </div>
                          <div className="rounded-lg border border-slate-200 bg-gradient-to-br from-purple-50 to-white p-4">
                            <p className="text-xs font-semibold uppercase tracking-wide text-purple-700">VIP prospect</p>
                            <p className="mt-2 text-sm text-slate-700">{log.notes3 || '-'}</p>
                          </div>
                        </div>
                      )}
                  </div>
                  ...
                  {Array.isArray(jathas) && jathas.length > 0 && (
                    <div className="rounded-xl border-2 border-red-200 bg-white p-5 shadow-sm">
                      <div className="mb-4 flex items-center gap-2">
                        ...
                        <h3 className="text-sm font-bold uppercase tracking-wider text-red-600">Jatha Details</h3>
                      </div>
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse">
                          <thead>
                            <tr className="border-b-2 border-red-200 bg-red-50">
                              <th className="px-4 py-2 text-left text-xs font-bold uppercase tracking-wide text-red-700">Area Name</th>
                              <th className="px-4 py-2 text-left text-xs font-bold uppercase tracking-wide text-red-700">Department</th>
                              <th className="px-4 py-2 text-left text-xs font-bold uppercase tracking-wide text-red-700">Days</th>
                              <th className="px-4 py-2 text-left text-xs font-bold uppercase tracking-wide text-red-700">Date From</th>
                              <th className="px-4 py-2 text-left text-xs font-bold uppercase tracking-wide text-red-700">Date To</th>
                            </tr>
                          </thead>
                          <tbody>
                            {jathas.map((j, i) => (
                              <tr key={i} className="border-b border-slate-100 hover:bg-slate-50">
                                <td className="px-4 py-3 text-sm font-medium text-slate-900">{j.areaName || '-'}</td>
                                <td className="px-4 py-3 text-sm text-slate-700">{j.departmentName || '-'}</td>
                                <td className="px-4 py-3 text-sm text-slate-700">{j.jathaTotalDay || '-'}</td>
                                <td className="px-4 py-3 text-sm text-slate-700">{j.dateFrom || '-'}</td>
                                <td className="px-4 py-3 text-sm text-slate-700">{j.dateTo || '-'}</td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
