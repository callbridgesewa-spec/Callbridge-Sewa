...
import { listCallLogsWithNominalList, updateCallLog, deleteCallLog } from '../../services/callLogsService'
...
function NominalRollPage() {
  ...
  const [viewEntry, setViewEntry] = useState(null) // { prospect, log }
  const [editEntry, setEditEntry] = useState(null) // { prospect, log }
      ...
      <header className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Prospects marked &quot;Yes&quot; for Nominal List in submitted calling forms
          </p>
        </div>
      ...
      <div className="overflow-hidden rounded-lg bg-white p-4 shadow-sm">
        ...
        {loading ? (
          ...
          <div className="py-12 text-center">
            ...
            <p className="mt-1 text-sm text-slate-500">
              When users submit calling forms with &quot;Nominal List Select&quot; set to &quot;Yes&quot;, they will appear here.
            </p>
          </div>
        ) : (
            ...
            <div className="flex-1 space-y-4 overflow-y-auto px-5 py-4 text-sm">
              <div className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2">
                ...
                <p className="mt-0.5 text-xs text-slate-600">
                  Badge: {viewEntry.prospect.badgeId || '-'} · Phone: {viewEntry.prospect.phoneNumber || '-'}
                </p>
              </div>
            ...
            >
              <div className="grid gap-3 md:grid-cols-2">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEditForm((f) => ({ ...f, select: e.target.value }))}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEditForm((f) => ({ ...f, callBack: e.target.value }))}
                    className="w-full rounded border border-slate-300 px-2 py-2 text-sm"
                  >
                    <option value="">Select</option>
                    <option value="Yes">Yes</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEditForm((f) => ({ ...f, notInterest: e.target.value }))}
                    className="w-full rounded border border-slate-300 px-2 py-2 text-sm"
                  >
                    <option value="">Select</option>
                    <option value="Yes">Yes</option>
                ...
                <div>
                  <label className="mb-1 block text-xs font-medium text-slate-600">Department of Sewa</label>
                  <input
                    type="text"
                    value={editForm.departmentOfSewa}
                    onChange={(e) => setEditForm((f) => ({ ...f, departmentOfSewa: e.target.value }))}
                    className="w-full rounded border border-slate-300 px-2 py-2 text-sm"
                  />
                </div>
              </div>
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEditForm((f) => ({ ...f, nominalListSelect: e.target.value }))}
                    className="w-full rounded border border-slate-300 px-2 py-2 text-sm"
                  >
                    <option value="">Select</option>
                    <option value="Yes">Yes</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEditForm((f) => ({ ...f, visitSelect: e.target.value }))}
                    className="w-full rounded border border-slate-300 px-2 py-2 text-sm"
                  >
                    <option value="">Select</option>
                    <option value="Yes">Yes</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEditForm((f) => ({ ...f, freeSewa: e.target.value }))}
                    className="w-full rounded border border-slate-300 px-2 py-2 text-sm"
                  >
                    <option value="">Select</option>
                    <option value="Yes">Yes</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEditForm((f) => ({ ...f, jathaRecord: e.target.value }))}
                    className="w-full rounded border border-slate-300 px-2 py-2 text-sm"
                  >
                    <option value="">Select</option>
                    <option value="Yes">Yes</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setEditForm((f) => ({ ...f, needToWork: e.target.value }))}
                  rows={4}
                  className="w-full rounded border border-slate-300 px-2 py-2 text-sm"
                />
              </div>
        ...
        >
          ...
          >
            ...
            <p className="mt-2 text-sm text-slate-600">
              ...
              <span className="font-semibold">{deleteEntry.prospect.name || '-'}</span>. This action cannot be undone.
            </p>
